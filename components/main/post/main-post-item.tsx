                ...
                <div className="group relative max-w-xl">
                  ...
                  <div className="mt-2 flex items-center gap-x-3 text-sm sm:hidden">
                    ...
                    <div className="inline-flex items-center text-gray-500">
                      ...
                      <span className="ml-1">
                        {format(parseISO(post.published_at ?? post.created_at ?? new Date().toISOString()), "dd/MM/yyyy")}
                      </span>
                    </div>
                    <div className="inline-flex items-center text-gray-500">
                  ...
                  <div className="mt-3 hidden items-center gap-x-3 text-sm sm:flex">
                    <div className="inline-flex items-center text-gray-500">
                      <CalendarIcon className="h-4 w-4" />
                      <span className="ml-1">
                        {format(parseISO(post.published_at ?? post.created_at ?? new Date().toISOString()), "MMMM dd, yyyy")}
                      </span>
                    </div>
                    <div className="inline-flex items-center text-gray-500">
                      <Clock10Icon className="h-4 w-4" />
